...
import guacamol_local
from guacamol_local.goal_directed_benchmark import GoalDirectedBenchmark, GoalDirectedBenchmarkResult
from guacamol_local.goal_directed_generator import GoalDirectedGenerator
from guacamol_local.benchmark_suites import goal_directed_benchmark_suite
from guacamol_local.utils.data import get_time_string
...
def assess_goal_directed_generation(goal_directed_molecule_generator: GoalDirectedGenerator,
    ...
    benchmark_results['guacamol_version'] = guacamol_local.__version__
